%==========================================================================
%This function performs Egger Weighted regression on the study data. It 
...
function data = EWRegression(XYZ, CElist, CSElist)
    ...
    [estimates, SE] = lscov([ones(1, length); precisionValues]', effectSize', weightsFFX');
